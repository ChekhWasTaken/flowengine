...
import com.chekhwastaken.testapp.databinding.Page0Binding;
...
public class Page0 extends FlowItemFragment<Page0Binding> {
    @Override
    ...
    protected void onViewCreated(Bundle args) {
        ...
        getBinding().text0.setOnClickListener(new View.OnClickListener() {
            @Override
